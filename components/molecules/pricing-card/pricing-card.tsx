    ...
    >
      <Card
        className={cn(
          ...
          isPremium &&
            "from-purple-100 via-purple-50 to-background border-purple-200 shadow-xl shadow-purple-100 dark:from-purple-500/20 dark:via-purple-400/10 dark:to-background dark:border-purple-500/30 dark:shadow-purple-500/10"
        )}
      >
        {isPremium && (
        ...
        <CardHeader>
          <h3
            className={cn(
              ...
              isPremium && "text-purple-600 dark:text-purple-300"
            )}
          >
            {name}
          </h3>
